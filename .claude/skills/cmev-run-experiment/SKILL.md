...
Read [AGENTS.md](../../../AGENTS.md), [CONTEXT.md](../../../CONTEXT.md), the [model training specification](../../../docs/specs/model_training_specification.md), the [evaluation plan](../../../docs/specs/evaluation_plan.md), the actual relevant module specification from the [index](../../../docs/specs/README.md), and [pipeline guidance](../../../pipelines/README.md). Use training recipes, registry/output requirements and metric definitions from these specifications, preserving proposed values as proposed until validated. Read [integration contracts](../../../docs/specs/integration_contracts.md) for adapter/transport experiments. Use the current implementation and accepted configuration, not a guessed command.
