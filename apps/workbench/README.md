...
The claim queue, standalone cost detail, operations dashboard and audit view are static design deliverables under `docs/mockups/`. No frontend package or runnable UI exists yet.
